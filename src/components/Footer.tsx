        ...
        <div className="flex flex-col md:flex-row justify-between gap-10 items-start">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-8 text-sm">
            <div className="flex flex-col gap-3">
              ...
              <Link to="/samantha"              className="hover:text-white transition-colors">AI Voice Receptionist</Link>
            ...
            <div className="flex flex-col gap-3">
              ...
              <Link to="/samantha"       className="hover:text-white transition-colors">Demo the AI Agent</Link>
