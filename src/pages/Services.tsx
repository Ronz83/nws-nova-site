...
const services = [
  ...
  },
  {
    ...
    description: "Nova is trained on your specific business — products, pricing, FAQs, and escalation rules. It handles unlimited concurrent inbound calls, qualifies leads, books calendar appointments, and syncs everything to your CRM automatically.",
    price: "From $299/mo",
    priceNote: "+ $499 one-time setup",
    features: [
      "Unlimited concurrent inbound call handling",
      "Custom semantic knowledge base training",
      "Live calendar booking integration (GHL / Calendly)",
      "CRM contact sync (HubSpot, Salesforce, GHL)",
  ...
  },
  {
    ...
    description: "We consolidate your customer data and marketing channels into a single GHL-powered dashboard. Contacts captured via web, phone, or chat are automatically tagged, scored, and dropped into nurture sequences — with zero manual effort.",
    price: "Included in retainer",
    priceNote: "Business plan ($599/mo)",
    features: [
      "GoHighLevel CRM workspace setup",
