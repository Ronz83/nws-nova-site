  ...
  return (
    <div className="min-h-screen bg-bg-base text-text-base relative overflow-hidden transition-colors duration-400">
      ...
      <div className="max-w-3xl mx-auto px-6 py-20 relative z-10 text-left font-sans">
        ...
        {/* Back Link */}
        <Link to="/" className="inline-flex items-center gap-2 text-sm uppercase tracking-widest text-sky-600 font-bold hover:underline mb-12">
          <ArrowLeft size={12} />
        ...
        <p className="text-sm font-mono text-text-muted uppercase tracking-widest mb-10">Last updated: June 10, 2026</p>

        <div className="space-y-8 text-sm sm:text-sm text-text-muted leading-relaxed font-semibold">
          ...
          <section>
            ...
            <p>
              NWS acts as a **Data Controller** when handling our direct visitors' or clients' information. When deploying custom AI Employees trained on client datasets that collect visitor contacts and transcribe calls, NWS acts as a **Data Processor** on behalf of the client.
            </p>
          </section>
