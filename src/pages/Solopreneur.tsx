...
// Countdown timer removed for permanent Solopreneur page
...
const faqs = [
  { q: 'What exactly is included?', a: 'The plan includes smart website design, integrated booking, AI receptionist widget, unified messaging inbox, CRM pipeline, and a free business listing on CaricomBusiness.com.' },
  ...
  { q: 'What is the Solopreneur plan price?', a: 'The Solopreneur plan is $297 USD monthly, or $2,970 USD annually, which gives you two months free.' },
];
...
export default function SolopreneurPage() {
  ...
  return (
    <div style={{ minHeight: '100vh', background: `linear-gradient(to bottom, ${C.bg}, ${C.bg2} 38%, ${C.bg})`, fontFamily: "'Open Sans', Arial, sans-serif", color: C.white }}>
      {/* Nav */}
      <div style={{ position: 'sticky', top: 0, zIndex: 35, backdropFilter: 'blur(18px)', background: 'rgba(8,15,30,0.68)', borderBottom: '1px solid rgba(255,255,255,0.07)' }}>
          ...
          <div style={{ alignSelf: 'start', maxWidth: 620, paddingTop: 6 }}>
            ...
            <div style={{ marginBottom: 24 }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 8 }}>
                <span style={{ fontSize: 14, fontWeight: 800, color: C.cyanLight, letterSpacing: '0.08em', textTransform: 'uppercase' }}>Business OS</span>
                <span style={{ color: C.muted, fontSize: 18 }}>•</span>
                <span style={{ fontSize: 14, fontWeight: 800, color: C.cyanLight, letterSpacing: '0.08em', textTransform: 'uppercase' }}>Solopreneur Plan</span>
              </div>
              <h1 style={{ fontSize: 'clamp(48px, 6vw, 84px)', lineHeight: 0.95, letterSpacing: '-0.075em', fontWeight: 900 }}>
                You Run the Business. <span style={{ background: `linear-gradient(100deg, ${C.cyan}, ${C.cyanLight} 48%, #a7f3d0 105%)`, WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text' }}>AI Runs the Front Desk.</span>
              </h1>
            </div>
            ...
            <p style={{ color: C.muted, lineHeight: 1.72, fontSize: 16, maxWidth: 610, marginBottom: 28 }}>
              Your AI chat widget answers visitors 24/7, SMS automation keeps leads warm, and your unified inbox makes sure nothing falls through the cracks. All for less than a part-time hire.
            </p>
            ...
            <div style={{ position: 'relative', zIndex: 2, minHeight: 542, display: 'grid', gridTemplateColumns: '1fr 1.28fr 1fr', gridTemplateRows: '122px 122px 122px 128px', gap: 12, paddingTop: 12 }}>
              ...
              <div style={{ gridColumn: '1 / -1', gridRow: 4, display: 'grid', gridTemplateColumns: 'minmax(170px, 215px) auto minmax(220px, 1fr)', gap: 20, alignItems: 'center', borderRadius: 24, padding: '22px 24px', background: 'rgba(8,15,30,0.9)', border: '1px solid rgba(56,189,248,0.32)', boxShadow: '0 24px 70px rgba(0,0,0,0.42), 0 0 60px rgba(14,165,233,0.14)' }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: 14 }}>
                  <img src="/assets/nws-logo.png" alt="NWS" style={{ width: 44, height: 44, objectFit: 'contain', filter: 'drop-shadow(0 8px 16px rgba(0,0,0,0.38))', flex: '0 0 auto' }} />
                  <div>
                    <div style={{ color: C.muted, fontSize: 10, fontWeight: 900, textTransform: 'uppercase', letterSpacing: '.14em', lineHeight: 1.22 }}>Solopreneur Plan</div>
                    <div style={{ color: C.soft, fontSize: 9, fontWeight: 700, letterSpacing: '0.09em', textTransform: 'uppercase', marginTop: 4, lineHeight: 1.25 }}>Flat Monthly Rate</div>
                  </div>
                </div>
      ...
      <section style={{ maxWidth: 1180, margin: '0 auto', padding: '48px 20px' }} id="value">
        ...
        <p style={{ textAlign: 'center', color: C.muted, fontSize: 12, maxWidth: 680, margin: '20px auto 0', lineHeight: 1.55 }}>
          ...
          <a href="/services" style={{ color: C.cyanLight, textDecoration: 'underline' }}>See all services on the main site</a> or{' '}
